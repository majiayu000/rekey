...
| Password change/reset and wrapper replacement | Specified | Not implemented; recovery key currently unlocks the Broker, satisfies explicit Admin step-up, or verifies backup restore only |
