...
| KEY-04 | VRK/DEK 轮换 | 同 VRK 下全版本 DEK 原子轮换已实现；完整 VRK 轮换正在设计锁定状态下的双因素操作 |
...
- 外部 25 个 ID 已形成 [具体最小规格提案](../specs/2026-09-16-external-capabilities.md)，包含官方 API 来源、信任/秘密归属、输入输出、失败合同及本地/现场验收；未实现、未创建外部资源。
